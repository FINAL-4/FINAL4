   ...
   <div id="mainContent" style=""><!-- mainContent -->
			...
			<br><br><br><br><br><br><br>
			 ...
			 <div class = "memberjoinForm">
					...
					<th>   우편번호</th>
					<td>
						<input type="text" name="post" class="postcodify_postcode5" value="" size="3">
					</td>
					<td>
							...
							<td>
								...
								<div class="person-content">
									<p>제 1 조 (목적)
											...
											- www.FIFAOFFLINE.co.kr
											
										
											② "서비스"라 함은 회사가 운영하는 사이트를 통해 개인이 구인 등의 목적으로 등록하는 자료를 DB화하여 각각의 목적에 맞게 분류 가공, 집계하여 정보를 제공하는 서비스와 사이트에서 제공하는 모든 부대 서비스를 말한다.
											③ "회원"이라 함은 "회사"가 제공하는 서비스를 이용하거나 이용하려는 자로, 외부 서비스 연동을 통해 "회사"와 이용계약을 체결한자 또는 체결하려는 자를 포함하며, 아이디와 비밀번호의 설정 등 회원가입 절차를 거쳐 회원가입확인 이메일 등을 통해 회사로부터 회원으로 인정받은 "개인회원"을 말한다.

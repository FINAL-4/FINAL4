				...
				<tr>
					<td id="joinUser${join.userNo }">
						<div class="chip">
  							...
  							${join.name }
  							<input type = button id = "agreeBtn${join.userNo}" class = agreeBtn name = "O" value="O" style="background: green; color:white; margin-left:50px;">
...
<div id="myModal" class="modal">
  <div class="modal-contentM animateM">
      ...
      <img src="resources/images/testimage/testimg4.png" alt="Avatar" class="avatarM">
    </div>

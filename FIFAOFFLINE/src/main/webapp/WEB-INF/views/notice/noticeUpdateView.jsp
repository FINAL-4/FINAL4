...
<div id="container" style="overflow: auto;"><!-- container -->
   <div id="mainContent" style="overflow: auto;"><!-- mainContent -->
				...
				<form id= updateForm action = "<%=request.getContextPath()%>/nupdate.do" method="post" encType="multipart/form-data">
				<div id="outer">
				<br><br><br><br>
				   <br>
				   <div id = "tableDiv">
				      <table align="center" id="listArea">
				         <tr>
				            ...
				            <td  class ="tableTd"><span style="padding-left: 17px; font-size: 16px;">${notice.nWriter }</span></td>
				         <tr>
